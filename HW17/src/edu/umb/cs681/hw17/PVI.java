...
public class PVI {
    ...
    public static void main(String[] args) {
        ...
        try (Stream<String> lines = Files.lines(path)) {
            ...
            System.out.println("Number of deaths occurred in the Suffolk county of the Massachusetts state are: " + suffolk.get(7));
            ...
            System.out.println("Total number of deaths in State of Massachusetts are: " + DeathsinM);

            System.out.println("Average number of deaths in State of Massachusetts are: " + Integer.parseInt(DeathsinM)/M.size());
